...
python test.py --data_root /media/hdd/derain/RainSyn25 \
               --eval_file /home/dxli/workspace/derain/proj/code/data/frames_heavy_test_JPEG_rgb.json \
               --backbone resnet18 \
               --refinenet R_CLSTM_5 \
               --use_bilstm \
               --input_residue \
	       ...
	       --F_npic \
               --loadckpt \
               --loadckpt_C /home/dxli/workspace/derain/proj/code/best_checkpoints/heavy/C/checkpoints_best_1176.pth.tar\
               --loadckpt_F /home/dxli/workspace/derain/proj/code/best_checkpoints/heavy/F/checkpoints_best_1176.pth.tar\
               --out_dir /home/dxli/workspace/derain/proj/out/heavy/1176
